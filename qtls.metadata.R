## load metadata
load.eqtl.data <- function(eqtl.datadir) {
...
load.pqtl.data <- function(pqtl.datadir, genes.info) {
    #system(paste("ls", datadir))
    ...
    pqtl.allscores.info <- rbind(pqtl.tscores.info, pqtl.cscores.info, fill=TRUE) # 4541 rowsp
